"""
Django settings for orange_unit_41539 project.
...
ROOT_URLCONF = 'orange_unit_41539.urls'
...
WSGI_APPLICATION = 'orange_unit_41539.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "orange_unit_41539 API",
    "DESCRIPTION": "API documentation for orange_unit_41539 App",
    "VERSION": "v1",
}
